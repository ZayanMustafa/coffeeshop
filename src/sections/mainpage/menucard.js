        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12">
          {MENU_CATEGORIES.map(category => (
            <button
              ...
              className={`px-6 py-2 rounded-full text-sm font-medium uppercase tracking-wider transition-colors ${activeCategory === category.id ? 'bg-[#6F4E37] text-white' : 'bg-[#F5F5F5] text-[#3E2723] hover:bg-[#E5E5E5]'}`}
            ...
            >
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-lg font-semibold" style={{ color: '#E5B80B', fontFamily: 'Montserrat, sans-serif' }}>
                    {item.price}
                  </span>
                </div>
                ...
                <button className="flex items-center text-sm font-semibold uppercase tracking-wider" style={{ color: '#6F4E37' }}>
